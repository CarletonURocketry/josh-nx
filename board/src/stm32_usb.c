/****************************************************************************
 * boards/arm/stm32h7/josh-stm32h753bi/src/stm32_usb.c
 *
...
#ifndef CONFIG_josh_STM32H753BI_USBHOST_PRIO
#  define CONFIG_josh_STM32H753BI_USBHOST_PRIO 100
#endif

#ifndef CONFIG_josh_STM32H753BI_USBHOST_STACKSIZE
#  define CONFIG_josh_STM32H753BI_USBHOST_STACKSIZE 1024
#endif
 ...
 *   USB-related GPIO pins for the josh-stm32h753bi board.
 *
 ****************************************************************************/
  ...
  if (g_usbconn)
    {
      ...
      ret = kthread_create("usbhost", CONFIG_josh_STM32H753BI_USBHOST_PRIO,
                           CONFIG_josh_STM32H753BI_USBHOST_STACKSIZE,
                           usbhost_waiter, NULL);
